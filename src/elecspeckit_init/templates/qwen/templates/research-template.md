...
3. **引用 skill_config.json**: Suggested sources 字段中的信息源应来自 `.elecspecify/memory/skill_config.json` 配置
...
- **skill_config.json**: 本文档的 Suggested sources 和 Research steps 依赖该配置文件
